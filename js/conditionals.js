...
var enterNumber = parseInt(prompt("What is your number?"));
...
if (userPrompt) {
  parseInt(enterNumber)
    ...
    //what number + 100
    enterNumber += 100;
    alert ("New number + 100 is " + enterNumber);

    //is number greater than 0 less than 0
    if (enterNumber < 0 ) {
...
if(wantsToEnterNumber) {
    ...
    alert(number + " plus 100 is: " + (100 + parseFloat(number)));
...
function analyzeColor(input) {
    ...
    if (input === "blue") {
        ...
        message = "yellow as lemonade";
    } else if (input === "green") {
        message = "grass is green";
    } else if (input === "violet") {
        message = "violet as lavender";
    } else {
...
function analyzeColor(input) {
    ...
    switch(input) {
        ...
        case "orange":
            ...
            break;
        case "yellow":
            message = "yellow as lemons";
            break;
        case "blue":
            message = "blue as the sky";
            break;
        case "green":
            message = "green as grass";
            break;
        case "violet":
            message = "violets are violets";
            break;
        case "indigo":
            message = "indigo as the indigo";
            break;
        default:
            message = " i don't know anything about that color " + input;
            break;
    }
...
function hasLetter(input) {
   ...
   return input.includes("a") || input.includes("b") || input.includes("c") ||
    input.includes("d") || input.includes("e") || input.includes("e") ||
...
function hasNumber(input) {
    ...
    return input.includes(0) || input.includes(1) || input.includes(2) ||
        ...
        input.includes(9) || input.includes(10);
}